...
import {
  ...
  Table, Divider, Skeleton, ScrollArea,
  Card, Grid,
} from '@mantine/core'
...
export function NominaDetalleModal({
  ...
  const roles = (detalle as unknown as {
    roles_pago?: {
      id: number
      servidor_id: number
      ...
      {isLoading ? (
        ...
        <Stack gap="md">
          ...
          <Grid>
            ...
            <Grid.Col span={{ base: 6, sm: 3 }}>
              <Card withBorder radius="md" p="sm" ta="center">
                <Text size="xs" c="dimmed">Total ingresos</Text>
            ...
            <Grid.Col span={{ base: 6, sm: 3 }}>
              <Card withBorder radius="md" p="sm" ta="center">
                <Text size="xs" c="dimmed">Total descuentos</Text>
