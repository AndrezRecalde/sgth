...
import { Stack, Group, Text, Badge, Button,
         Collapse, Divider, Skeleton, ActionIcon,
         Tooltip } from '@mantine/core'
import { useDisclosure } from '@mantine/hooks'
import { IconPlus, IconTrash, IconEdit,
         IconChevronDown, IconChevronRight,
         IconUsers, IconHeart } from '@tabler/icons-react'
...
function CargaRow({ carga, servidorId, onEdit, onDelete }: CargaRowProps) {
  ...
  const hasCondiciones = carga.persona_con_discapacidad
