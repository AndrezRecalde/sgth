...
import {
  Drawer, Tabs, Avatar, Group, Stack, Text,
  Badge, Button, ThemeIcon, ScrollArea,
} from '@mantine/core'
import {
  IconUser, IconBriefcase, IconSchool,
  IconUsers, IconCreditCard, IconPaperclip,
  IconFileDescription, IconHeart, IconEdit,
...
export function ServidorDetail({
  opened, onClose, servidor, onEdit,
}: Props) {
    ...
    <Drawer
      ...
      title={
        <Group gap="xs">
          ...
          <Text fw={700} size="md">Expediente Digital</Text>
        </Group>
      }
      position="right"
        ...
        <Stack gap="md">
          ...
          >
            ...
            <Stack gap={2} style={{ flex: 1 }}>
              <Text fw={700} size="md">{nombreCompleto}</Text>
              ...
              <Group gap="xs">
                ...
                {servidor.contrato_vigente?.estado && (
                  <Badge
                    color={servidor.contrato_vigente.estado === 'vigente'
                      ? 'emerald' : 'gray'}
                    variant="dot"
                    size="xs"
                  >
          ...
          <Tabs defaultValue="personal" color="emerald">
            <Tabs.List>
              ...
              <Tabs.Tab value="academico"
                leftSection={<IconSchool size={13} />}>
                Académico
              </Tabs.Tab>
              <Tabs.Tab value="familia"
              ...
              <Tabs.Tab value="declaraciones"
                leftSection={<IconFileDescription size={13} />}>
                Declaraciones
              </Tabs.Tab>
              <Tabs.Tab value="condicion"
            ...
            <Tabs.Panel value="condicion" pt="md">
              <CondicionTab
                ...
                tieneDiscapacidad={servidor.tiene_discapacidad}
                tieneEnfermedadCatastrofica={
