...
import {
  ...
  Button, Grid, TextInput, ActionIcon,
  Divider, Badge, Alert, Select,
  NumberInput, ThemeIcon,
} from '@mantine/core'
...
export function FacturasModal({
  ...
  const categoriaOptions = (categorias as CategoriaFactura[])
    .map(c => ({
      value: String(c.id),
      label: c.nombre,
    }))
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Stack gap="md">
          ...
          <Stack gap="sm">
            {fields.map((field, i) => {
              const tipoComp =
                watch(`facturas.${i}.tipo_comprobante`)
                ...
                >
                  ...
                  <Grid>
                    ...
                    <Grid.Col span={{ base: 12, sm: 4 }}>
                      <Controller
                        name={
                          `facturas.${i}.categoria_factura_id`
                        }
                        control={control}
                        render={({ field: f }) => (
                          <Select
                    ...
                    <Grid.Col span={{ base: 12, sm: 6 }}>
                      {tipoComp === 'ticket' ? (
                        <TextInput
                          ...
                          {...contained}
                          {...register(
                            `facturas.${i}.numero_ticket`
                          )}
                          error={
                            errors.facturas?.[i]
                              ?.numero_ticket?.message
                          }
                        />
                      ) : (
                        <TextInput
