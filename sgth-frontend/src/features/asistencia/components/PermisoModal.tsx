...
import { IconCheck, IconInfoCircle,
         IconFileDownload } from '@tabler/icons-react'
...
export function PermisoModal({ opened, onClose, isAdmin = true }: Props) {
  ...
  const [permisoCreado, setPermisoCreado] =
    useState<PermisoServidor | null>(null)
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <Stack gap="sm">
            ...
            {tipoWatch === 'personal' && (
              ...
              >
                <Text size="xs">
                  Los permisos personales tienen un máximo de 4 horas
                  y se descuentan del saldo de vacaciones.
                </Text>
              </Alert>
            )}
