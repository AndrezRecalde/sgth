...
import { AtencionOdontologicaPanel } from
  '@/features/dispensario/components/AtencionOdontologicaPanel'
...
export default function OdontologiaDetallePage({ params }: Props) {
